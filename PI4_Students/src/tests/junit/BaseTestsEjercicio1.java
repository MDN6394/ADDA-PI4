...
public class BaseTestsEjercicio1 {

    public static List<Integer> expectedOutput;
    private static String outputPath = "/salida/ejercicio1/";
    ...
    private static void readOutput() {
    	...
    	for(int i=1;i<=3;i++) {
			...
			try {
			    ...
			    expectedOutput.add(Integer.parseInt(line));
			} catch (IOException e) {
